#include<bits/stdc++.h>
#include"SolucionRK4.h"

using namespace std;

	double SolucionRK4::FuncionReal(int circuito, double x, double A){
	...
	void SolucionRK4::Analitica(int caso, double a, double w, double xi, double dxi, double ti, double tf, double dt){
